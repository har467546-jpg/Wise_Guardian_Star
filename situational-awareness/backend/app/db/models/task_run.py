...
class TaskRun(Base):
    ...
    execution_boundary: Mapped[str | None] = mapped_column(String(32), nullable=True, index=True)
    runner_asset_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
    scanner_zone_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
