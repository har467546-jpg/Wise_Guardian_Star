...
SETTINGS_SECTIONS = [
    ...
    PlatformSettingsSectionRead(
        ...
        fields=[
            ...
            "campus_default_portset_mode",
            "campus_allow_full_scan_default",
            "campus_zone_host_concurrency_limit",
            "campus_zone_nmap_min_rate",
            "campus_dhcp_default_interval_seconds",
            "campus_snmp_default_interval_seconds",
...
FIELD_TO_ENV_KEY = {
    ...
    "discovery_enable_arp_discovery": "DISCOVERY_ENABLE_ARP_DISCOVERY",
    "discovery_enable_fping": "DISCOVERY_ENABLE_FPING",
    "discovery_nmap_host_discovery_profile": "DISCOVERY_NMAP_HOST_DISCOVERY_PROFILE",
    ...
    "campus_default_portset_mode": "CAMPUS_DEFAULT_PORTSET_MODE",
    "campus_allow_full_scan_default": "CAMPUS_ALLOW_FULL_SCAN_DEFAULT",
    "campus_zone_host_concurrency_limit": "CAMPUS_ZONE_HOST_CONCURRENCY_LIMIT",
    "campus_zone_nmap_min_rate": "CAMPUS_ZONE_NMAP_MIN_RATE",
    "campus_dhcp_default_interval_seconds": "CAMPUS_DHCP_DEFAULT_INTERVAL_SECONDS",
    "campus_snmp_default_interval_seconds": "CAMPUS_SNMP_DEFAULT_INTERVAL_SECONDS",
...
def get_platform_settings_read() -> PlatformSettingsRead:
    ...
    return PlatformSettingsRead(
        ...
        discovery_liveness_mode=str(settings.DISCOVERY_LIVENESS_MODE or "multi_source"),
        discovery_enable_arp_discovery=bool(getattr(settings, "DISCOVERY_ENABLE_ARP_DISCOVERY", True)),
        discovery_enable_fping=bool(getattr(settings, "DISCOVERY_ENABLE_FPING", True)),
        discovery_nmap_host_discovery_profile=str(getattr(settings, "DISCOVERY_NMAP_HOST_DISCOVERY_PROFILE", "balanced") or "balanced"),
        ...
        campus_default_portset_mode=str(getattr(settings, "CAMPUS_DEFAULT_PORTSET_MODE", "top1000_plus_custom") or "top1000_plus_custom"),
        campus_allow_full_scan_default=bool(getattr(settings, "CAMPUS_ALLOW_FULL_SCAN_DEFAULT", False)),
        campus_zone_host_concurrency_limit=int(getattr(settings, "CAMPUS_ZONE_HOST_CONCURRENCY_LIMIT", 8)),
        campus_zone_nmap_min_rate=int(getattr(settings, "CAMPUS_ZONE_NMAP_MIN_RATE", 5000)),
        campus_dhcp_default_interval_seconds=int(getattr(settings, "CAMPUS_DHCP_DEFAULT_INTERVAL_SECONDS", 1800)),
        campus_snmp_default_interval_seconds=int(getattr(settings, "CAMPUS_SNMP_DEFAULT_INTERVAL_SECONDS", 1800)),
