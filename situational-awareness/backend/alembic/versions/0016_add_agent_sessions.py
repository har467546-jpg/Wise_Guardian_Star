...
def upgrade() -> None:
    ...
    inspector = sa.inspect(bind)
    _create_index_if_missing(inspector, "agent_sessions", "ix_agent_sessions_agent_id", ["agent_id"])
    _create_index_if_missing(inspector, "agent_sessions", "ix_agent_sessions_user_id", ["user_id"])
    _create_index_if_missing(inspector, "agent_sessions", "ix_agent_sessions_status", ["status"])
    ...
    inspector = sa.inspect(bind)
    _create_index_if_missing(inspector, "agent_messages", "ix_agent_messages_session_id", ["session_id"])
    _create_index_if_missing(
        inspector,
        "agent_messages",
